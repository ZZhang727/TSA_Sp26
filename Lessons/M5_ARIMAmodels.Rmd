...
#We get large P-value, we accept the theory that we have unit root, so we need to detrend.
...
deseasonal_residential_price_diff <- 
  diff(deseasonal_residential_price, lag =1)
...
#The stochastic effect is gone. The plot is not decaying anympre
...
#The model 111 has a lower aic, so when removing the AR, the model does not improve. 
